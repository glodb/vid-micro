...
type User struct {
	...
	AvatarUrl         sql.NullString `db:"avatar_url VARCHAR(255)" json:"avatar_url,omitempty" form:"avatar_url,omitempty"`
	...
	DeletedAt         sql.NullTime   `db:"deletedAt TIMESTAMPTZ DEFAULT NULL" json:"deletedAt,omitempty"`
	PasswordHash      sql.NullString `db:"password_hash TEXT"`
	VerificationToken sql.NullString `db:"verification_token VARCHAR(255)" json:"verification_token,omitempty" form:"verification_token,omitempty"`
}
